...
def random_item(users):
    ...
    def chooserand(users):
        def choose(users, b1, b2):
            ...
            congrats1 = tk.Label(window, text=f"You got {y}!", bg="#c6e5dc", fg="green", font=("Calibri", 20))
            congrats1.place(x=30,y=50)
            congrats2 = tk.Label(window, text=f"You now have {users[own].getMiles()} Asia Miles left!", bg="#c6e5dc", fg="green", font=("Calibri", 20))
    ...
    l1=tk.Label(window, text="You now have " + str(users[own].getMiles()) + " Asia Miles,", bg="#c6e5dc", font=("Calibri", 22))
    l1.place(x=30,y=400)
	
    l1=tk.Label(window, text="are you sure you want to draw?", bg="#c6e5dc", font=("Calibri", 22))
    l1.place(x=30,y=450)
